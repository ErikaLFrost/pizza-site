...
const aboutUsSpan =
    `Vi är tre vänner som bakar neapolitansk-inspirerad vegansk/vegetarisk pizza utav högsta kvalitet & utan genvägar.
...
const AboutUs = () => {
    return (
        <SectionComponent title={aboutUsTitle} spanText={aboutUsSpan} bgImage={aboutUsImg} />
    )
}
